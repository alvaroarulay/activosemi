  ...
  methods: {
    ...
    registrarAsignacion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        me.pdf ='http://172.16.110.28:8080/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&codcont='+ me.codcont + '';
        me.modalpdf = 1;
      }
      else{
        let me = this;
        me.pdf ='http://172.16.110.28:8080/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&data='+ me.checkContables + '';
        me.modalpdf = 1;
      }
    },
    cerrarModalpdf(){
    ...
    registrarDevolucion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        me.pdf='http://172.16.110.28:8080/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&codcont='+ me.codcont +  '';
        me.modalpdf = 1;
      }
      else{
        let me = this;
        me.pdf='http://172.16.110.28:8080/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp + '&data='+ me.checkContables +  '';
        me.modalpdf = 1;
      }
    },
